...
def parse(): 
	...
	parser.add_argument("--migration", 
		help = """The migration model to assume: 'diffusion', 'linear', \
'sudden', or 'post-process'. (Default: diffusion)""", 
		type = str, 
		default = "diffusion") 

	parser.add_argument("--evolution", 
		help = """The star formation history to assume: 'static', 'insideout', \
'lateburst', or 'outerburst' (Default: insideout)""", 
		type = str, 
		default = "insideout") 
